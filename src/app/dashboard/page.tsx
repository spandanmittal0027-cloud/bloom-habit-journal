...
export default async function DashboardHomePage() {
  ...
  // of waiting on each one in turn — this alone cuts the page's server-side
  // data-fetch time by roughly two-thirds.
  const [profile, { data: habits }, { data: recentLogs }] = await Promise.all([
