...
export default async function ProgressPage({
  ...
  // habits, this month's logs, and the full year of history don't depend
  // on each other — fetch all three at once instead of one after another.
  const [{ data: habits }, { data: monthLogsRaw }, { data: historyLogsRaw }] =
    await Promise.all([
      supabase
        .from("habits")
        .select("*")
