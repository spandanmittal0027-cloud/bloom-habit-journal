...
export default async function SettingsPage() {
  ...
  // Profile is deduped via getCurrentProfile (shared with the layout's
  // call), so this page only adds one new query: habits.
  const [profile, { data: habits }] = await Promise.all([
